      ...
      <div className='bg-white rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-center items-center p-14 pt-6'>
        <div>
          <div>
            ...
            <p className='text-md text-gray-400 mt-1'>Post a content to your account</p>
          </div>
          ...
          justify-center items-center outline-none mt-10 w-[260px] h-[460px] p-10 cursor-pointer hover:border-purple-300 hover:bg-gray-100'>
            {Loading ? (
              ...
              <div>
                {videoAsset ? (
                  <div className=' rounded-xl  flex flex-col justify-center items-center w-[260px] h-[460px]'>
                    <video
                      src={videoAsset.url}
                      loop
                      controls
            ...
            {wrongFileType && (
              <p className='text-center text-xs text-red-400 font-semibold mt-4 w-[25 0px]'>
                Please select a file (mp4 or webm or ogg or MOV)
              </p>
            )}
          </div>
          
        </div>
        <div className='flex flex-col gap-3 pb-10 mt-5'>
